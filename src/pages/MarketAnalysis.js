...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, CircularProgress, Alert, Pagination, Box, Button, Dialog, DialogTitle, DialogContent, DialogActions, Grid, TextField, MenuItem } from '@mui/material';
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell>Market Movement</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {rows.map((row, idx) => (
                        <TableRow key={row.id || idx}>
                            ...
                            <TableCell>{row.premarket_analysis}</TableCell>
                            <TableCell>{row.postmarket_analysis}</TableCell>
            ...
            <DialogContent>
                <Grid container spacing={2} sx={{ mt: 1 }}>
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField
                            fullWidth
                            label="Post-Market Analysis"
                            name="postmarketanalysis"
